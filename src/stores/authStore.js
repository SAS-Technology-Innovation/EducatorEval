...
import { signInWithEmailAndPassword, createUserWithEmailAndPassword, sendPasswordResetEmail, signInWithPopup, GoogleAuthProvider, signOut, onAuthStateChanged } from 'firebase/auth';
        ...
        const unsubscribe = onAuthStateChanged(auth, async (firebaseUser) => {
            ...
            if (firebaseUser) {
                try {
                    ...
                    let userData = null;
                    try {
                        userData = await usersService.getById(firebaseUser.uid);
                        if (userData) {
                    ...
                    if (!userData && firebaseUser.email) {
                        ...
                        try {
                            ...
                            const existingUserByEmail = allUsers.find((user) => user.email === firebaseUser.email);
