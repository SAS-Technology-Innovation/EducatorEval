        ...
        <div className="sas-hero-overlay min-h-screen">
              ...
              <div className="flex justify-between items-center py-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/80 font-poppins">Singapore American School</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <a 
                    href="/login" 
                    className="bg-white/20 backdrop-blur-sm text-white px-6 py-3 rounded-lg text-sm font-poppins font-semibold hover:bg-white/30 transition-all duration-200 border border-white/30"
                  >
                    Sign In
                  </a>
                </div>
          ...
          <main className="flex items-center justify-center min-h-[80vh]">
            <div className="text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <p className="text-2xl sm:text-3xl text-white/90 font-poppins font-light mb-4">
                Excellence in Educational Evaluation
              </p>
              <p className="text-lg text-white/80 max-w-2xl mx-auto leading-relaxed mb-12 font-poppins">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                <a 
                  href="/login" 
                  className="bg-white text-sas-navy-600 px-10 py-4 rounded-lg text-lg font-poppins font-semibold hover:bg-white/90 shadow-xl transition-all duration-200 hover:shadow-2xl hover:scale-105 flex items-center justify-center"
                >
                  Get Started
                  <ArrowRight className="w-5 h-5 ml-2" />
                </a>
                <button className="border-2 border-white text-white px-10 py-4 rounded-lg text-lg font-poppins font-semibold hover:bg-white/10 backdrop-blur-sm transition-all duration-200 flex items-center justify-center">
      ...
      <section className="bg-sas-background py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bebas text-sas-navy-600 tracking-wider mb-4">Platform Features</h2>
            <p className="text-xl text-sas-gray-600 font-poppins">Excellence in educational evaluation</p>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-sas-gray-200 hover:bg-white/90 transition-all duration-200">
            ...
            <p className="text-sas-gray-600 font-poppins">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-12 text-center border border-sas-gray-200">
            ...
            <p className="text-sas-gray-600 mb-8 max-w-2xl mx-auto font-poppins">
              Join educators and administrators using EducatorEval to enhance teaching practices and student outcomes.
            </p>
            <a 
              href="/login" 
              className="bg-sas-gradient text-white px-8 py-3 rounded-xl text-lg font-semibold font-poppins hover:opacity-90 shadow-lg transition-all duration-200 hover:shadow-xl inline-flex items-center"
            >
              Sign In Now
