        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-sas-gray-600 font-poppins">Welcome, {user?.email}</span>
              <button
                onClick={handleLogout}
                className="bg-sas-red-500 text-white px-4 py-2 rounded-lg hover:bg-sas-red-600 transition-colors flex items-center space-x-2 font-poppins"
              >
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="bg-sas-green-50 border border-sas-green-200 rounded-xl p-4 mb-6">
            <div className="flex items-center">
              ...
              <p className="text-sm text-sas-green-800 font-poppins">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-sas-gray-600 font-poppins">Name</p>
                <p className="text-lg font-semibold text-sas-gray-900 font-poppins">{user?.displayName}</p>
              </div>
              <div>
                <p className="text-sm text-sas-gray-600 font-poppins">Email</p>
                <p className="text-lg font-semibold text-sas-gray-900 font-poppins">{user?.email}</p>
              </div>
              <div>
                <p className="text-sm text-sas-gray-600 font-poppins">Role</p>
                <p className="text-lg font-semibold text-sas-gray-900 font-poppins capitalize">{user?.primaryRole.replace('_', ' ')}</p>
              </div>
              <div>
                <p className="text-sm text-sas-gray-600 font-poppins">Employee ID</p>
                <p className="text-lg font-semibold text-sas-gray-900 font-poppins">{user?.employeeId}</p>
              </div>
            </div>
          </div>
              ...
              <div className="p-6">
                <div className="flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-sas-gray-600 font-poppins">Create and view observations</p>
                  </div>
                </div>
              </div>
            </a>
              ...
              <div className="p-6">
                <div className="flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-sas-gray-600 font-poppins">Manage your profile</p>
                  </div>
                </div>
              </div>
            </a>
              ...
              <div className="p-6">
                <div className="flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-sas-gray-600 font-poppins">Configure preferences</p>
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="bg-white shadow-lg overflow-hidden rounded-xl">
            <div className="px-6 py-6">
              ...
              <p className="text-sas-gray-600 font-poppins">No recent activity to display.</p>
            </div>
          </div>
        </div>
      </main>
