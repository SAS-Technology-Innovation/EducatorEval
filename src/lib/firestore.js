...
export const firestoreQueries = {
    ...
    async getUserObservations(teacherId, limitCount = 50) {
    ...
    async getSchoolsByOrganization(organizationId) {
    ...
    async getDivisionsBySchool(schoolId) {
    ...
    async getDepartmentsByDivision(divisionId) {
