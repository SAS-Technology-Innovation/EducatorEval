      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <button className="bg-sas-navy-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-sas-navy-700 flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex items-center">
              <div className="w-8 h-8 bg-sas-navy-100 rounded-lg flex items-center justify-center">
                <Target className="w-4 h-4 text-sas-navy-600" />
              </div>
              <div className="ml-3">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          {activeTab === 'goals' ? (
            <div className="text-center py-12">
              ...
              <button className="bg-sas-navy-600 text-white px-6 py-2 rounded-lg hover:bg-sas-navy-700 text-sm font-medium">
