        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-sas-navy-600">Districts</p>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sas-navy-500 focus:border-transparent"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div className="mt-6 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full ${
                systemSettings.maintenanceMode ? 'bg-sas-navy-600' : 'bg-gray-200'
              }`}
            >
              <span
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full ${
                systemSettings.allowRegistration ? 'bg-sas-navy-600' : 'bg-gray-200'
              }`}
            >
              <span
                className={`inline-block h-4 w-4 transform rounded-full bg-white transition ${
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            className="px-6 py-2 bg-sas-navy-600 text-white rounded-md hover:bg-sas-navy-700"
          >
            Save Settings
          </button>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="text-center p-4 border rounded-lg">
            <div className="text-2xl font-bold text-sas-navy-600">{stats.totalUsers}</div>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
            ...
            className="flex items-center justify-center p-4 border border-blue-200 rounded-lg hover:bg-sas-navy-50 transition-colors"
          >
            <Download className="w-5 h-5 text-sas-navy-600 mr-2" />
            <span className="font-medium text-sas-navy-600">Create Backup</span>
          </button>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-lg mx-4 max-h-screen overflow-y-auto">
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-sas-navy-600 text-white rounded-md hover:bg-sas-navy-700 transition-colors"
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sas-navy-500 focus:border-transparent"
                    />
                    <button
                      type="button"
                      onClick={addDivision}
                      className="px-3 py-2 bg-sas-navy-600 text-white rounded-md hover:bg-sas-navy-700"
                    >
                      Add
                    </button>
                  </div>
