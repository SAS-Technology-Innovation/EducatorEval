...
export interface User {
  ...
  schoolId: string;
  divisionId: string;
  primaryDepartmentId?: string; // Main department for analytics and scheduling
  departmentIds: string[]; // All departments (for teachers in multiple departments)
  ...
  subjects: string[]; // All subjects taught (for multi-subject teachers)
  grades: string[];
